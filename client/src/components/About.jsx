            ...
            <div className="flex flex-col items-start justify-start gap-4">
                ...
                {awards.map((award, index) => (
                    <div key={index} className="flex flex-col gap-[2px]">
                        ...
                        <a href={ award.link } className="text-sm underline underline-offset-8 decoration-accentLight dark:decoration-accentDark hover:decoration-black hover:dark:decoration-white">{ award.linkText }</a>
                    </div>
                ))}
            </div>
            <div className="flex flex-col items-start justify-start gap-4">
                ...
                {articles.map((article, index) => (
                    <div key={index} className="flex flex-col gap-[2px]">
                        ...
                        <a href={ article.link } className="text-sm underline underline-offset-8 decoration-accentLight dark:decoration-accentDark hover:decoration-black hover:dark:decoration-white">{ article.linkText }</a>
                    </div>
                ))}
            </div>
            <div className="flex items-start justify-start"></div>
